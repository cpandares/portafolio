  ...
  return (
    <nav className="w-full h-14 hidden bg-white lg:flex p-4 justify-between fixed z-10 dark:bg-gray-800">
      <div className="h-auto w-auto">
        <p className="text-xl text-primary font-black">PlatziTravel</p>
      </div>
      <div className="flex space-x-8 ">
        <a href="#home" className="font-bold text-md text-primary ">
          Home
        </a>
        <a href="#recomendadas" className="font-bold text-md text-primary ">
          Recomendados
        </a>
        <a
        ...
        <a href="#faqs" className="font-bold text-md text-primary ">
          FAQs
        </a>
        <a href="#footer" className="font-bold text-md text-primary ">
          Nosotros
        </a>
      </div>
      <div className="flex space-x-3">
        ...
        <button id="toggle">
          ...
          >
            <path
              className="ffill-current text-primary"
